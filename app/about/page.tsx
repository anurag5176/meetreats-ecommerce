  ...
  return (
    <div className="flex flex-col">
      ...
      <section
        ...
        style={{
          backgroundImage: 'url("/about%20us%20hero.png")',
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="space-y-6">
                <p
                  className={`montserrat text-charcoal/70 text-base sm:text-lg leading-relaxed font-light transition-all duration-700 ease-out ${
                    isMissionVisible
                      ? "opacity-100 translate-y-0"
                      : "opacity-0 translate-y-8"
                  }`}
            ...
            <div
              className={`bg-white/80 backdrop-blur-sm border border-royal-gold/30 shadow-xl rounded-2xl p-8 transition-all duration-700 ease-out ${
                isMissionVisible
                  ? "opacity-100 translate-x-0"
                  : "opacity-0 translate-x-8"
              }`}
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12 max-w-6xl mx-auto">
            ...
            <div
              className={`text-center group sm:col-span-2 lg:col-span-1 transition-all duration-700 ease-out ${
                isValuesVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-8"
              }`}
      ...
      <section ref={teamRef} className="py-16 sm:py-20 lg:py-24 bg-soft-cream">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 gap-8 sm:gap-12 max-w-4xl mx-auto">
            <div
              className={`bg-white/80 backdrop-blur-sm border border-royal-gold/30 shadow-xl rounded-2xl p-8 text-center group hover:shadow-2xl transition-all duration-700 ease-out ${
                isTeamVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-8"
              }`}
