...
export function DesignYourOwn() {
  ...
  const generateQuote = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `MeeTreats-Gift-Quote-${Date.now()}.pdf`;
  ...
  return (
    <section
      id="design-your-own"
      ref={sectionRef}
      className="pb-16 sm:pb-20 lg:pb-24 bg-soft-cream"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <div
          className={`text-center mb-14 sm:mb-16 lg:mb-20 transition-all duration-700 ease-out ${
            isSectionVisible
        ...
        >
          ...
          <h2
            className="cormorant-garamond text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-dark-chocolate font-semibold tracking-tight"
            style={{
              fontWeight: "700",
          ...
          <p className="montserrat text-lg sm:text-xl text-charcoal/70 max-w-3xl mx-auto leading-relaxed font-light tracking-wide mt-6">
            Build a custom gift hamper from scratch. Select products, set your
            budget, and create something truly special.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Budget Slider */}
            <Card
              className={`bg-white/80 backdrop-blur-sm border border-royal-gold/30 shadow-xl rounded-2xl transition-all duration-700 ease-out ${
                isSectionVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-8"
              }`}
            ...
            >
              <CardHeader className="pb-6">
                <CardTitle
                  className="cormorant-garamond text-2xl font-black text-dark-chocolate"
              ...
              <CardContent>
                ...
                {selectedProducts.length > 6 && (
                  <p className="montserrat text-sm text-red-600 mt-4">
                    Maximum 6 products can be selected per gift.
                  </p>
                )}
              </CardContent>
            </Card>
            ...
            >
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center space-x-3 p-4 bg-gradient-to-r from-royal-gold/5 to-[#D4AF37]/5 rounded-xl border border-royal-gold/20">
                  ...
                  >
                    Include custom message card (+₹50 per gift)
                  </Label>
                </div>
          ...
          <div className="lg:col-span-1">
            <Card
              className={`sticky top-24 bg-white/80 backdrop-blur-sm border border-royal-gold/30 shadow-xl rounded-2xl transition-all duration-700 ease-out ${
                isSectionVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-8"
              }`}
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3 pt-6">
                  <Button
                    ...
                    className="w-full text-white font-semibold py-3 rounded-full transition-all duration-300 hover:shadow-lg hover:scale-105 active:scale-95 montserrat"
                  ...
                  <Button
                    variant="outline"
                    className="w-full bg-transparent border-royal-gold/40 text-royal-gold hover:bg-royal-gold/10 hover:border-royal-gold rounded-full py-3 transition-all duration-300 montserrat"
                    asChild
                  >
                    <a
                      href={`https://wa.me/919876543210?text=Hi! I'm interested in custom gift hampers. Budget: ₹${budgetPerUnit} per gift, Quantity: ${quantity}`}
                      target="_blank"
                ...
                <p className="text-xs text-charcoal/60 montserrat font-light">
