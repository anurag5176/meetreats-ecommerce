export function ProductsHero() {
  return (
    <section
      ...
      style={{
        backgroundImage: 'url("/products%20hero.png")',
        ...
        <div className="text-left max-w-4xl">
          ...
          <div className="h-[60vh] flex flex-col justify-center">
            ...
            <div className="mb-8">
              ...
              <h1
                className="cormorant-garamond text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-royal-gold font-semibold tracking-tight animate-fade-in-up animate-delay-200"
                style={{
                  fontWeight: "700",
            ...
            {/* Sub-headline (mobile: white + shadow, desktop: dark) */}
            <div className="relative z-10 text-white sm:text-dark-chocolate/80 [text-shadow:0_2px_6px_rgba(0,0,0,0.5)] sm:[text-shadow:none] transition-all duration-700">
              <p className="montserrat text-lg sm:text-xl leading-[32px] sm:leading-[36px] mb-8 sm:mb-10 max-w-2xl text-pretty font-light tracking-wide animate-fade-in-up animate-delay-400">
                Discover a world of activated nuts and dehydrated fruits, each
                meticulously crafted for exceptional taste and well-being.
              </p>
            </div>
