          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div className="space-y-4">
              <p className="montserrat text-lg text-dark-chocolate/80 leading-relaxed font-light">
                From handpicked artisanal treats to custom-branded hampers, every box reflects care, quality, and distinction. Whether you're appreciating partners, honoring achievers, or nurturing relationships, our premium collections turn gestures into lasting impressions.
              </p>
              <p className="montserrat text-base text-dark-chocolate/70 leading-relaxed font-light">
                Tailored branding, luxury packaging, and large-volume dispatch available.
              </p>
            </div>
            ...
            <div className="pt-4">
              ...
              >
                <span className="mr-3">Explore Signature Gifting Solutions</span>
