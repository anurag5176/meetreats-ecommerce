    ...
    <section ref={sectionRef} className="relative py-20 sm:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl text-left">
          {/* Headline */}
          <h2 className={`cormorant-garamond text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-royal-gold font-semibold tracking-tight mb-8 transition-all duration-700 ease-out ${
            isSectionVisible 
              ? 'opacity-100 translate-y-0' 
              : 'opacity-0 translate-y-8'
          }`} style={{fontWeight: '700', textShadow: '0 2px 4px rgba(0,0,0,0.3)', transitionDelay: '0.2s'}}>
            CRAFTED WITHOUT COMPROMISE
          </h2>
          
          {/* Body text */}
          <p className={`montserrat text-lg sm:text-xl text-soft-cream leading-relaxed mb-12 max-w-3xl font-light transition-all duration-700 ease-out ${
            isSectionVisible 
              ? 'opacity-100 translate-y-0' 
              : 'opacity-0 translate-y-8'
