        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 lg:gap-12">
          ...
          <div className="flex-shrink-0">
            <div className="flex flex-col">
              ...
              <p className="montserrat text-white/70 text-xs sm:text-sm mt-2 sm:mt-3">
                For daily inspiration and mindful indulgence.
              </p>
            </div>
          </div>

          {/* Company Links - Aligned with header logo center position */}
          <div className="space-y-4 sm:space-y-6 flex-1 flex justify-center">
          ...
          {/* Legal & Social */}
          <div className="space-y-4 sm:space-y-6 flex-1 flex justify-end lg:justify-start lg:pl-20">
            <div className="space-y-4 sm:space-y-6">
              <h3 className="montserrat font-semibold text-white text-sm lg:text-base uppercase tracking-wider">
                Legal
              </h3>
